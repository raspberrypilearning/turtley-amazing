...
-   Variables are a way of storing a value, and giving it a name. So forinstance there is a variable names `R` with a value of `255`. Run the code and see what happens. Try changing the values of the three variables, and see what happens. (Note - the maximum value is 255, and after this there will be no affect.)
...
- So this has made a multicoloured spiral, by changing the `R`, `G`, and `B` variables, but the colours are a little one-dimensional. Can you do a better job?

## Loopy colours

- To get more interesting colours, you could write lots of colours in a big long list, and then keep changing the colour of the turtle according to the colour of the list.
...
- Have a look at the code below. Run it to see what happens.
...
- What if you want a longer line? Try changing the number of loops in the `for` loop to `range(20)` and see what happens.
- Do you get an error?
